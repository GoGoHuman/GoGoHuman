...
if ( is_admin () ) {
            ...
            function human_meta_boxes_scripts () {
                        ...
                        wp_enqueue_script ( 'meta-boxes-inteface', GO_HUMAN_BASE_URL . '/friends/meta-boxes/f-character/temper/meta-boxes-interface.js', array (
                                    'jquery',
                                    'human-admin-script',
                                    'quicktags' ) );
                        wp_enqueue_script ( 'load-post-boxes', GO_HUMAN_BASE_URL . '/friends/meta-boxes/f-character/temper/load-post-boxes.js', array (
                                    'meta-boxes-inteface' ) );
