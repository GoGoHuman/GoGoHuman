...
if ( ! defined ( 'CMB_PATH' ) )
            define ( 'CMB_PATH', GO_HUMAN_BASE_PATH . '/friends/meta-boxes/f-heart/Custom-Meta-Boxes/' );

if ( ! defined ( 'CMB_URL' ) )
            define ( 'CMB_URL', GO_HUMAN_BASE_URL . '/friends/meta-boxes/f-heart/Custom-Meta-Boxes/' );
